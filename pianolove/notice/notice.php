...
<DIV class="fl"><A class="btn_img fl" href="notice.php"><I class="fa fa-bars"></I>목록</A>				
<FORM class="bd_srch_btm on" name="board_form" action="notice.php?table=<?=$table?>&amp;mode=search" method="post">
...
<FIELDSET>
	<STRONG class="direction"><I class="fa fa-angle-left"></I> <A href="notice.php?table=<?=$table?>&amp;page=<?=($page<=1)?(1):($page-1)?>">Prev</A></STRONG>	
<?
...
?>			
	...
	<STRONG class="direction"><A href="notice.php?table=<?=$table?>&amp;page=<?=($page>=$total_page)?($total_page):($page+1)?>">Next</A><I class="fa fa-angle-right"></I></STRONG>	
