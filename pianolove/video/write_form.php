...
<A class="caption" href="http://127.0.0.1/">
...
<TABLE class="bd_lst bd_tb_lst bd_tb">
  <THEAD class="bg_f_f9">
	...
	<TR>
		<TD "author"><SPAN>링크</SPAN></TD>
		<TD class="title"><input type="text" name="link" value="<?=$item_link?>" style="width:100%" placeholder="https://www.youtube.com/watch?v=(이 부분만 입력)"></TD>
	</TR>
	<TR>
		<TD "author"><SPAN>커버 사진</SPAN></TD>
...
<a href="video.php?table=<?=$table?>&page=<?=$page?>"><img src="../files/img/list.png"></a>
</div>
</form>
