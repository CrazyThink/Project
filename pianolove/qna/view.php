...
<H1 class="fadeInDown-1">Q&A</H1></A>
...
<?
	    $sql = "select * from qna_ripple where parent='$item_num'";
...
<DIV class="fl"><A class="btn_img fl" href="qna.php"><I class="fa fa-bars"></I>목록</A>				
<FORM class="bd_srch_btm on" name="board_form" action="qna.php?table=<?=$table?>&amp;mode=search" method="post">
...
<FIELDSET>
	...
	<STRONG class="direction"><I class="fa fa-angle-left"></I> <A href="qna.php?table=<?=$table?>&amp;page=<?=($page<=1)?(1):($page-1)?>">Prev</A></STRONG>	
<?
...
<?
		...
		{ 
			echo "<a href='qna.php?table=$table&page=$i'> $i </a>";
		}      
   }
?>			
	
	<STRONG class="direction"><A href="qna.php?table=<?=$table?>&amp;page=<?=($page>=$total_page)?($total_page):($page+1)?>">Next</A><I class="fa fa-angle-right"></I></STRONG>		
