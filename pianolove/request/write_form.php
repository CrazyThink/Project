...
<TABLE class="bd_lst bd_tb_lst bd_tb">
  <THEAD class="bg_f_f9">
	<TR>
		...
		<TD class="title"><?=$usernick?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="html_ok" value="y"> HTML 쓰기</TD>
	</TR>	
	<TR>
    ...
    <TR>
		<TD "author"><SPAN>내용</SPAN></TD>
		<TD class="title"><textarea rows="20%" name="content" style="resize:none"><?=$item_content?></textarea></TD>
	</TR>
	<TR>
		<TD "author"><SPAN>이미지파일1</SPAN></TD>
...
?>
	...
	<TR>
		<TD "author"><SPAN>이미지파일3</SPAN></TD>
		<TD class="title"><input type="file" name="upfile[]">
<? 	if ($mode=="modify" && $item_file_2)
	{
?>
		<div class="delete_ok"><?=$item_file_2?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="20"> 삭제</div>
		<div class="clear"></div>
<?
	}
?>
...
<a href="request.php?table=<?=$table?>&page=<?=$page?>"><img src="../files/img/list.png"></a>
</div>
</form>
